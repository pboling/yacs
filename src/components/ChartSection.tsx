...
export const ChartSection: React.FC<ChartSectionProps> = ({
  ...
  const displayedSeriesKeys = Array.from(new Set([selectedMetric, 'liquidity'])).filter((k) =>
  ...
  return (
    <div style={{ borderTop: '1px solid #374151', paddingTop: 12 }}>
            ...
            {metricOptions.map((opt) => (
              <label
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: 4,
                  fontWeight: selectedMetric === opt.key ? 700 : 400,
                  color: selectedMetric === opt.key ? palette[opt.key] : undefined,
                }}
              >
                <input
                  type="radio"
      ...
      <div style={{ position: 'relative', width: '100%', height }}>
        {!hasData && (
          <div
            style={{
              ...
              animation: 'chart-skel 3s linear infinite',
              borderRadius: 4,
            }}
          >
            {emptyMessage}
        ...
        >
          <polyline
            points={`4,${height - 4} ${600 - 4},${height - 4}`}
            stroke="#374151"
            strokeWidth="1"
            fill="none"
          />
          {displayedSeriesKeys.map((k) => {
            ...
            return (
              <path
                ...
                fill="none"
                style={
                  k === selectedMetric ? { filter: `drop-shadow(0 0 2px ${palette[k]}88)` } : {}
                }
              />
            )
          })}
          ...
          return (
            <span
              ...
              style={{
                ...
                alignItems: 'center',
                gap: 4,
                fontWeight: k === selectedMetric ? 700 : 400,
                color: palette[k],
              }}
            >
              <span
